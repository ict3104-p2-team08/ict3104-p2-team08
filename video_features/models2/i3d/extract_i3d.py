...
from models2.i3d.i3d_src.i3d_net import I3D
from models2.pwc.extract_pwc import DATASET_to_PWC_CKPT_PATHS
from models2.raft.extract_raft import DATASET_to_RAFT_CKPT_PATHS
...
class ExtractI3D(BaseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        """Defines the models2, loads checkpoints, sends them to the device.
        ...
        i3d_weights_paths = {
            'rgb': './models2/i3d/checkpoints/i3d_rgb.pt',
            'flow': './models2/i3d/checkpoints/i3d_flow.pt',
        }
        name2module = {}
        ...
        if "flow" in self.streams:
            ...
            if self.flow_type == 'pwc':
                from models2.pwc.pwc_src.pwc_net import PWCNet
        ...
        # Feature extraction models2 (rgb and flow streams)
        i3d_stream_models = {}
        for stream in self.streams:
