...
from models2.s3d.s3d_src.s3d import S3D
from models2.transforms import CenterCrop, Resize, ToFloatTensorInZeroOne
...
class ExtractS3D(BaseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        ...
        """
        s3d_kinetics400_weights_torch_path = './models2/s3d/checkpoint/S3D_kinetics400_torchified.pt'
