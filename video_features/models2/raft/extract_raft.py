...
import omegaconf
from models2._base.base_flow_extractor import BaseOpticalFlowExtractor

# defined as a constant here, because i3d imports it
DATASET_to_RAFT_CKPT_PATHS = {
    'sintel': './models2/raft/checkpoints/raft-sintel.pth',
    'kitti': './models2/raft/checkpoints/raft-kitti.pth',
}
