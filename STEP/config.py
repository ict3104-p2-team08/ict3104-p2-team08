...
def parse_config():
    ...
    parser.add_argument('--data_root', default='./datasets/ava/', help='Location of dataset root directory')
    parser.add_argument('--save_root', default='./datasets/ava/cache',
    ...
    parser.add_argument('--kinetics_pretrain', default=None, type=str2none,
                        help='Path to the Kinetics pretrained model')
    ...
    parser.add_argument('--video_name', default='Debug', help='video name')
    parser.add_argument('--model_name', default='Debug', help='model Name')
    parser.add_argument('--video_train', default='Debug', help='')
    parser.add_argument('--video_test', default='Debug', help='')
    ...
    parser.add_argument('--topk', default=-1, type=int,
                        help='topk scores for selection and evaluation (default -1 for all scores)')
    ...
    parser.add_argument('--cls_thresh', default="0.2", type=str,
                        help='threshold for selecting positive example for action classification')
    parser.add_argument('--reg_thresh', default="0.2", type=str,
                        help='threshold for selecting positive example for regression')
    ...
    parser.add_argument('--selection_sampling', default="softmax", type=str,
                        help='choice of sampling method for choosing proposals: uniform | random | softmax')
    parser.add_argument('--selection_score', default="score", type=str,
                        help='choice of sampling method for choosing proposals: score | iou')
    ...
    parser.add_argument('--do_flip', default=False, type=str2bool,
                        help='Use random horizontal flipping for data augmentation')
    parser.add_argument('--do_crop', default=False, type=str2bool, help='Use random cropping for data augmentation')
    parser.add_argument('--do_photometric', default=False, type=str2bool,
                        help='Use photometric distortion for data augmentation')
    ...
    parser.add_argument('--iterative_mode', default="temporal", type=str,
                        help='choice of iterative update mode: spatial | temporal')
    parser.add_argument('--temporal_mode', default="extrapolate", type=str,
                        help='choice of temporal update mode: extrapolate | predict')
    parser.add_argument('--anchor_mode', default="1", type=str, help='choice of anchor mode: 1 | 2 | 3 | 4')
    parser.add_argument('--scale_norm', default=1, type=int,
                        help='whether to normalize the scale: 0 for [0,255] | 1 for [0,1] | 2 for [-1,1]')
    ...
    parser.add_argument('--cycle_decay', default=1.0, type=float,
                        help='Reduce the base_lr after the completion of each cycle.')
