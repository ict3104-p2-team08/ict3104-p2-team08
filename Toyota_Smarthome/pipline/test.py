...
parser.add_argument('-load_model', type=str, default='./models/PDAN') # change default from "False" to "./models/PDAN"
...
activityList = ["Enter", "Walk", "Make_coffee.Get_water", "Make_tea/put something in sink", "unknown class 4", "Use_Drawer", "unknown class 6", "Use_telephone",
       "Leave", "Put_something_on_table", "Drink.From_glass",  "unknown class 11",  "unknown class 12", "Drink.From_cup", "Dump_in_trash",  "unknown class 15",
       "unknown class 16", "Use_cupboard",  "unknown class 18", "Read", "Drink.From_bottle", "Use_fridge", "Wipe_table/clean dish with water",  "unknown class 23",
...
def create_caption_video(arrayWithCaptions):
    import cv2
    cap = cv2.VideoCapture('C:/Users/leech/Toyota_Smarthome/pipline/' + fileName + ".mp4")
